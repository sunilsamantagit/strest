...
if(empty($default_lng)){$default_lng='-106.656611';}
    ...
    $image = base_url('public/default/images/marker_ph.png');
// pre($logo_photo);
?>
<!DOCTYPE html >
  <head>
...
white-space:nowrap;
    ...
    function load() {
      ...
      downloadUrl("<?php echo site_url("common/google_map_xml/".$id);?>", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
          ...
          //var html = "<div class='hook noscrollbar'><b>" + name + "</b></div>";
          // var html = "<div class='hook noscrollbar'><b><h3>" + name + "</h3></b>" + address+"</div>";
          var html = "<div class='hook noscrollbar'><b>" + name + "</b><br/><b>Address: </b>"+ address +"<br/><a href='https://www.google.com/maps/dir/current+location/"+ lat +","+ lng +"' target='_blank'>Get directions</a></div>";
