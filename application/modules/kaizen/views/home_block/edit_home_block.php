...
<div class="rightDiv">
  <div class="right-outer">
    ...
    <h3 class="title">Add Home Block</h3>
    <?php } ?>
    <div class="clear"></div>
    <div class="mid-block padbot40">
      <div class="mid-content web-cont-mid">
        <div id="webcont-form">
		  ...
		  echo form_hidden('home_block_id', $details->id);
		...
		?>
            ...
            <div class="single-column">
              ...
              <input type="text" name="home_block_title" id="home_block_title" value="<?php if(isset($details->title)){echo $details->title;}?>" class="inputinpt validate[required]" />
            </div>
	          ...
	          <input id="htmlfile1" name="htmlfile1" value="<?php if(!empty($details->home_block_photo)) echo $details->home_block_photo; ?>" type="text">
	          <a href="<? echo front_base_url().'filemanager/dialog.php?type=1&field_id=htmlfile1&relative_url=1'?>?>" class="btn iframe-btn" type="button">Open File Manager</a> 
                  ...
                  <?php
                  if(!empty($details->home_block_photo)){
                    $head_img=$details->home_block_photo;
                  }else{
