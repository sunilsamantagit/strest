        			  ...
        			  ?>
        					<tr>
                             ...
                             <td><?php if(!empty($row->title)) echo $row->title; ?></td>
                                   <?php 
                                   $home_block_photo= base_url('public/images.png');
                                   if($row->home_block_photo!=''){	
                                      $path2 = str_replace(base_url().'public/uploads/',file_upload_absolute_path(),$row->home_block_photo);
                                   if(is_file($path2)) { $home_block_photo=$row->home_block_photo; }}
                                    ?>
				<td> <img src="<?php echo $home_block_photo;?>" style="background:black;" width="75" height="50"/> </td>
