...
<!--                            <th>View Tracking</th>-->
                ...
                <td>
                    <a class="block-btn edit-btn" href="<?php echo site_url("kaizen/user/doedit/".$row->id);?>"><span>Edit</span></a> <a href="javascript:void(0);" title="Delete" onclick="rowdelete('<?php echo $row->id; ?>','admin');" class="delete3 delete-red-btn"><span>Delete</span></a>
                    </td>
<!--                    <td>
